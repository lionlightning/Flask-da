...
def analysis(filename):
    ...
    df3.to_excel(writer, sheet_name='Table 3')
    df4.to_excel(writer, sheet_name='Table 4')
    df5.to_excel(writer, sheet_name='Table 5')
    df6.to_excel(writer, sheet_name='Table 6')
    df7.to_excel(writer, sheet_name='Table 7')
    df8.to_excel(writer, sheet_name='Table 8')
    df9.to_excel(writer, sheet_name='Table 9')
    writer.save()
